								...
								<div id="login-box" class="login-box widget-box no-border visible">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form class="" id="form1" method="post" action="${pageContext.request.contextPath}/admin/login.do">
												<fieldset>
										<ul>
   <li class="frame_style form_error"><label class="user_icon"></label><input value="${admin.username}" type="text"  name="username" id="username"/><i>用户名</i></li>
   <li class="frame_style form_error"><label class="password_icon"></label><input  type="password" value="${admin.username}"  name="password" id="userpwd"/><i>密码</i></li>
