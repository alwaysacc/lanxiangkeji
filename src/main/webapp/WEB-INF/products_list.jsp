...
<meta http-equiv="Cache-Control" content="no-siteapp" /> 
        ...
        <script type="${pageContext.request.contextPath}/text/javascript" src="js/H-ui.js"></script>
        <script type="${pageContext.request.contextPath}/text/javascript" src="js/H-ui.admin.js"></script>
 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="${pageContext.request.contextPath}/product/product-add.do" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
