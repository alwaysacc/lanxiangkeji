...
public class ExportExcelUtil {
     ...
     *            文件名
     */
    public void getOutputFile(String[] title, String[] column,List<Map> data, String fileName,String path) {
        ...
        try {
            ...
            palette.setColorAtIndex((short) 12, (byte) (0x41), (byte) (0x69),
                    (byte) (0xE1));
            level1Style.setFillPattern(level1Style.getFillPatternEnum().SOLID_FOREGROUND);
            level1Style.setFillForegroundColor((short) 9);
            HSSFCellStyle level2Style = workbook.createCellStyle();
            level2Style.setFillPattern(level1Style.getFillPatternEnum().SOLID_FOREGROUND);
            level2Style.setFillForegroundColor((short) 10);
            HSSFCellStyle level3Style = workbook.createCellStyle();
            level3Style.setFillPattern(level1Style.getFillPatternEnum().SOLID_FOREGROUND);
            level3Style.setFillForegroundColor((short) 11);
            HSSFCellStyle level4Style = workbook.createCellStyle();
            level4Style.setFillPattern(level1Style.getFillPatternEnum().SOLID_FOREGROUND);
