...
public class EmailManager {
    ...
    public static String username = "alwaysacc@163.com"; // 服务邮箱(from邮箱)
    public static String password = "alwaysacc1"; // 邮箱密码
    public static String senderNick = "懒象科技";   // 发件人昵称
...
//          mimeMsg.setFrom(new InternetAddress(from));
    ...
    public static void main(String[] args) {
        ...
        String[] to = {"1214895040@qq.com", "xx@zhuxiongxian.cc"};
